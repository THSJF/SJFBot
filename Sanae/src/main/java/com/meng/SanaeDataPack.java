...
public class SanaeDataPack {
	...
	private SanaeDataPack(int opCode, long timeStamp) {
		...
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(0));
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(headLength));
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes((short)1));
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(timeStamp));
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(0L));
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(opCode));
	}   
	...
	private SanaeDataPack(SanaeDataPack dataPack) {
		...
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(0));
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(headLength));
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(dataPack.getVersion()));
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(dataPack.getTimeStamp()));
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(dataPack.getTarget()));
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(dataPack.getOpCode()));
	}
	...
	public int getLength() {
		return BitConverter.getInstanceLittleEndian().toInt(dataArray, 0);
	}  

	public short getHeadLength() {
		return BitConverter.getInstanceLittleEndian().toShort(dataArray, 4);
	}

	public short getVersion() {
		return BitConverter.getInstanceLittleEndian().toShort(dataArray, 6);
	}

	public long getTimeStamp() {
		return BitConverter.getInstanceLittleEndian().toLong(dataArray, 8);
	}

	public long getTarget() {
		return BitConverter.getInstanceLittleEndian().toLong(dataArray, 16);
	}

	public int getOpCode() {
		return BitConverter.getInstanceLittleEndian().toShort(dataArray, 24);
	}
	...
	public SanaeDataPack write(short s) {
		...
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(s));
		return this;
	}

	public SanaeDataPack write(int i) {
		writeByteDataIntoArray(typeInt);
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(i));
		return this;
	}

	public SanaeDataPack write(long l) {
		writeByteDataIntoArray(typeLong);
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(l));
		return this;
	}

	public SanaeDataPack write(float f) {
		writeByteDataIntoArray(typeFloat);
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(f));
		return this;
	}

	public SanaeDataPack write(double d) {
		writeByteDataIntoArray(typeDouble);
		writeByteDataIntoArray(BitConverter.getInstanceLittleEndian().getBytes(d));
		return this;
	}

	public SanaeDataPack write(String s) {
		writeByteDataIntoArray(typeString);
		byte[] stringBytes = BitConverter.getInstanceLittleEndian().getBytes(s);
	...
	public short readShort() {
		if (dataArray[dataPointer++] == typeShort) {
			short s = BitConverter.getInstanceLittleEndian().toShort(dataArray, dataPointer);
			dataPointer += 2;
			return s;
		}
	...
	public int readInt() {
		if (dataArray[dataPointer++] == typeInt) {
			int i= BitConverter.getInstanceLittleEndian().toInt(dataArray, dataPointer);
			dataPointer += 4;
			return i;
		}
	...
	public long readLong() {
		if (dataArray[dataPointer++] == typeLong) {
			long l= BitConverter.getInstanceLittleEndian().toLong(dataArray, dataPointer);
			dataPointer += 8;
			return l;
		}
	...
	public float readFloat() {
		if (dataArray[dataPointer++] == typeFloat) {
			float f = BitConverter.getInstanceLittleEndian().toFloat(dataArray, dataPointer);
			dataPointer += 4;
			return f;
		}
	...
	public double readDouble() {
		if (dataArray[dataPointer++] == typeDouble) {
			double d = BitConverter.getInstanceLittleEndian().toDouble(dataArray, dataPointer);
			dataPointer += 8;
			return d;
		}
	...
	public String readString() {
		try {
			if (dataArray[dataPointer++] == typeString) {
				int len = readInt();
				String s = BitConverter.getInstanceLittleEndian().toString(dataArray, dataPointer, len);
				dataPointer += len;
				return s;
			}

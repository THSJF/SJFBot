    ...
    public static final List<HK3Equipment> equipments = Collections.unmodifiableList(new ArrayList<HK3Equipment>(){
            {
                ...
                add(new HK3Equipment(CharaName.KianaKaslana, "天穹游侠", "女武神·游侠", ArmType.Machin, Attack.Physics, false, true, false));   
                ...
                add(new HK3Equipment(CharaName.KianaKaslana, "空之律者", "白骑士·月光", ArmType.Biology, Attack.Physics, true, false, false));
                add(new HK3Equipment(CharaName.KallenKaslana, "圣仪装·今样", "领域装·白练", ArmType.Machin, Attack.Physics, true, false, false));
                add(new HK3Equipment(CharaName.KallenKaslana, "原罪猎人", "女武神·游侠", ArmType.Machin, Attack.Physics, true, false, false));
                add(new HK3Equipment(CharaName.KallenKaslana, "第六夜想曲", "圣女祈祷", ArmType.Extra, Attack.Ice, true, false, false));
                ...
                add(new HK3Equipment(CharaName.RaidenMei, "破晓强袭", "女武神·强袭", ArmType.Biology, Attack.Physics, false, true, false));
                add(new HK3Equipment(CharaName.RaidenMei, "脉冲装·绯红", ArmType.Biology, Attack.Physics));  
                add(new HK3Equipment(CharaName.RaidenMei, "影舞冲击", ArmType.Machin, Attack.Physics));
                add(new HK3Equipment(CharaName.RaidenMei, "断罪影舞", "影舞冲击", ArmType.Machin, Attack.Physics, false, true, false));
                add(new HK3Equipment(CharaName.RaidenMei, "雷电女王的鬼铠", ArmType.Extra, Attack.Thunder));
                add(new HK3Equipment(CharaName.RaidenMei, "雷之律者", "雷电女王的鬼铠", ArmType.Extra, Attack.Thunder, true, false, false));
                add(new HK3Equipment(CharaName.YaeSakura, "御神装·勿忘", "影舞冲击", ArmType.Machin, Attack.Ice, true, false, false));
                add(new HK3Equipment(CharaName.YaeSakura, "逆神巫女", "脉冲装·绯红", ArmType.Biology, Attack.Physics, true, false, false));
                add(new HK3Equipment(CharaName.YaeSakura, "真炎幸魂", "女武神·强袭", ArmType.Biology, Attack.Fire, true, false, false));
                add(new HK3Equipment(CharaName.YaeSakura, "夜隐重霞", null, ArmType.Biology, Attack.Thunder, false, false, true));
                ...
                add(new HK3Equipment(CharaName.BronyaZaychik, "彗星驱动", "驱动装·山吹", ArmType.Extra, Attack.Physics, false, true, false));
                add(new HK3Equipment(CharaName.BronyaZaychik, "银狼的黎明", "驱动装·山吹", ArmType.Extra, Attack.Physics, true, false, false));
                add(new HK3Equipment(CharaName.BronyaZaychik, "雪地狙击", ArmType.Biology, Attack.Physics));
                add(new HK3Equipment(CharaName.BronyaZaychik, "异度黒核侵蚀", "雪地狙击", ArmType.Biology, Attack.Physics, true, false, false));
                add(new HK3Equipment(CharaName.BronyaZaychik, "次元边界突破", ArmType.Machin, Attack.Physics));
                add(new HK3Equipment(CharaName.BronyaZaychik, "理之律者", "次元边界突破", ArmType.Machin, Attack.Ice, true, false, false));
                add(new HK3Equipment(CharaName.BronyaZaychik, "迷城骇兔", null, ArmType.Extra, Attack.Physics, false, false, true));
                ...
                add(new HK3Equipment(CharaName.MurataHimeko, "真红骑士·月蚀", "融核装·深红", ArmType.Machin, Attack.Fire, true, false, false));
                add(new HK3Equipment(CharaName.MurataHimeko, "极地战刃", ArmType.Extra, Attack.Ice));
                add(new HK3Equipment(CharaName.MurataHimeko, "战场疾风", "极地战刃", ArmType.Biology, Attack.Physics, true, false, false));
                ...
                add(new HK3Equipment(CharaName.TheresaApocalypse, "月下初拥", "女武神·誓约", ArmType.Extra, Attack.Physics, true, false, false));
                add(new HK3Equipment(CharaName.TheresaApocalypse, "处刑装·紫苑", ArmType.Machin, Attack.Physics));
                add(new HK3Equipment(CharaName.TheresaApocalypse, "暮光骑士·月煌", "处刑装·紫苑", ArmType.Machin, Attack.Physics, false, true, false));
                add(new HK3Equipment(CharaName.TheresaApocalypse, "朔夜观星", null, ArmType.Biology, Attack.Physics, false, false, true));
                ...
                add(new HK3Equipment(CharaName.FuHua, "雾都迅羽", "女武神·迅羽", ArmType.Extra, Attack.Physics, false, true, false));
                add(new HK3Equipment(CharaName.FuHua, "影骑士·月轮", ArmType.Machin, Attack.Thunder));
                add(new HK3Equipment(CharaName.FuHua, "识之律者", "影骑士·月轮", ArmType.Biology, Attack.Physics, true, false, false));
                add(new HK3Equipment(CharaName.FuHua, "炽翎", ArmType.Extra, Attack.Fire));
                add(new HK3Equipment(CharaName.FuHua, "云墨丹心", "炽翎", ArmType.Extra, Attack.Fire, true, false, false));
                ...
                add(new HK3Equipment(CharaName.RozaliyaOlenyeva, "狂热蓝调△", "樱桃炸弹", ArmType.Extra, Attack.Physics, false, true, false));
                ...
                add(new HK3Equipment(CharaName.Asuka, "明日福音", null, ArmType.Biology, Attack.Physics, false, false, true));
                add(new HK3Equipment(CharaName.Fischl, "断罪皇女！！", null, ArmType.Biology, Attack.Thunder, false, false, true));
            }
        });

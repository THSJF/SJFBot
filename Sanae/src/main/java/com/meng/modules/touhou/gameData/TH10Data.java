...
public class TH10Data extends THGameData {
    ...
    private TH10Data() {
        ...
        spells = new THSpell[]{
            ...
            new THSpell(this, chara_键山雏, "创符「流放人偶」", "創符「流刑人形」", THSpell.Hard | THSpell.Lunatic),
            ...
            new THSpell(this, chara_射命丸文, "风神「天狗颪」", "風神「天狗颪」", THSpell.Hard),
            ...
            new THSpell(this, chara_东风谷早苗, "开海「海水分开之日」", "開海「海が割れる日」", THSpell.Easy | THSpell.Normal),
            ...
            new THSpell(this, chara_八坂神奈子, "神谷「Divining Crop」（神灵之谷）", "神穀「ディバイニングクロップ」", THSpell.Lunatic),
            new THSpell(this, chara_八坂神奈子, "贽符「御射山御狩神事」", "贄符「御射山御狩神事」", THSpell.Easy | THSpell.Normal),
            new THSpell(this, chara_八坂神奈子, "神秘「葛井之清水」", "神秘「葛井の清水」", THSpell.Hard),
            new THSpell(this, chara_八坂神奈子, "神秘「Yamato Torus」（大和环面）", "神秘「ヤマトトーラス」", THSpell.Lunatic),

...
public class TH12Data extends THGameData {
    ...
    private TH12Data() {
        ...
        spells = new THSpell[]{
            ...
            new THSpell(this, chara_圣白莲, "魔法「魔界蝶之妖香」", "魔法「魔界蝶の妖香」", THSpell.Easy | THSpell.Normal),
            new THSpell(this, chara_圣白莲, "魔法「Magic Butterfly」（魔法之蝶）", "魔法「マジックバタフライ」", THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_圣白莲, "光魔「Star Maelstrom」（星辰之涡）", "光魔「スターメイルシュトロム」", THSpell.Easy | THSpell.Normal),
            ...
            new THSpell(this, chara_圣白莲, "「圣尼公之大空卷轴」", "「聖尼公のエア巻物」", THSpell.Normal | THSpell.Hard),
            new THSpell(this, chara_圣白莲, "超人「圣白莲」", "超人「聖白蓮」", THSpell.Lunatic),
            new THSpell(this, chara_圣白莲, "飞钵「Flying Fantastica」（幻想的飞行）", "飛鉢「フライングファンタスティカ」", THSpell.Easy | THSpell.Normal),
